...
//        musicBar4.setBackgroundColor(foregroundColor);
        musicBar1.setBackground(getResources().getDrawable(R.drawable.background_corner));
        musicBar2.setBackground(getResources().getDrawable(R.drawable.background_corner));
        musicBar3.setBackground(getResources().getDrawable(R.drawable.background_corner));
        musicBar4.setBackground(getResources().getDrawable(R.drawable.background_corner));
        setPivots();
    }
        ...
        musicBar4.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (musicBar4.getHeight() > 0) {
                    musicBar4.setPivotY(musicBar1.getHeight());
                    if (Build.VERSION.SDK_INT >= 16) {
    ...
    public void animateBars() {
        animating = true;
        if (playingSet == null) {
            ObjectAnimator scaleYbar4 = ObjectAnimator.ofFloat(musicBar4, "scaleY", 0.2f, 0.8f, 0.1f, 0.6f, 0.3f, 0.1f, 0.3f, 0.8f, 0.7f, 0.3f, 0.4f, 0.6f, 0.7f, 0.6f, 0.1f, 0.3f, 0.5f, 0.4f, 0.1f, 0.6f, 0.7f, 0.9f, 0.5f, 0.6f, 0.5f, 0.1f);
            ...
            playingSet.playTogether(scaleYbar2, scaleYbar3, scaleYbar1, scaleYbar4);
    ...
    public void stopBars() {
        ...
        if (stopSet == null) {
            ...
            stopSet.playTogether(scaleY3, scaleY2, scaleY1,scaleY4);
